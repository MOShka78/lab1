...
bool calc_determinant(lab1::Determinant::Request  &req,
         lab1::Determinant::Response &res)
{
...
int main(int argc, char **argv)
{
  ...
  service = n.advertiseService("matrix_determinant", calc_determinant);
